...
def get_grades():
    ...
    print("  with headers:", login_response.headers)
    print("-------------------------------")
    ...
    url_content = BASE_URL + "/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=COURSERESULTS&ARGUMENTS=" + arguments[79:]
    print("url content url:", url_content)
    semester_ids_response = requests.get(url_content, cookies=login_response.cookies)
    print("  res:", semester_ids_response)
